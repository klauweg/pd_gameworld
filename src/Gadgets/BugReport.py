...
class BugReport(commands.Cog):
    ...
    async def bug(self, ctx: commands.Context, arg):
        ...
        await client.get_channel(self.bugreportschannelid).send(embed=embed, delete_after=10)
        ...
        message: discord.Message = await client.get_channel(self.modreportschannelid).send(embed=embed)
        ...
        if user != client.user:
            if payload.message.channel.id == self.modreportschannelid:
                ...
                if payload.emoji == "✔️":
                    ...
                    devmessage = await client.get_channel(self.devreportschannelid).send(embed=embed)
                    await devmessage.add_reaction("✔️")
                    embed = discord.Embed(title="Done!", description="You accepted the bug!",color=0x49ff35)
                    embed.set_author(name="BugReport",icon_url="https://cdn.discordapp.com/app-icons/742032003125346344/e4f214ec6871417509f6dbdb1d8bee4a.png?size=256")
                    embed.set_thumbnail(url="https://cdn.discordapp.com/app-icons/742032003125346344/e4f214ec6871417509f6dbdb1d8bee4a.png?size=256")
                    await client.get_channel(self.modreportschannelid).send(embed=embed, delete_after=10)
                    await message.delete()
                if payload.emoji == "❌":
                    await message.delete()
                ...
                if payload.emoji == "✅":
                    embed: discord.Embed = message.embeds[0]
                    await client.get_user(embed.fields[2].name).ban()
                    await message.delete()
                    ...
                    embed.set_author(name="BugReport",icon_url="https://cdn.discordapp.com/app-icons/742032003125346344/e4f214ec6871417509f6dbdb1d8bee4a.png?size=256")
                    embed.set_thumbnail(url="https://cdn.discordapp.com/app-icons/742032003125346344/e4f214ec6871417509f6dbdb1d8bee4a.png?size=256")
                    banmessage: discord.Message = await client.get_channel(self.modreportschannelid).send(embed=embed, delete_after=500)
                    await banmessage.add_reaction("🆘")
                if payload.emoji == "🟨":
                    embed: discord.Embed = message.embeds[0]
                    guild: discord.Guild = client.get_guild(741823660188500008)
                    ...
                    try:
                        ...
                        embed.set_author(name="BugReport",icon_url="https://cdn.discordapp.com/app-icons/742032003125346344/e4f214ec6871417509f6dbdb1d8bee4a.png?size=256")
                        embed.set_thumbnail(url="https://cdn.discordapp.com/app-icons/742032003125346344/e4f214ec6871417509f6dbdb1d8bee4a.png?size=256")
                        await client.get_channel(self.modreportschannelid).send(embed=embed, delete_after=20)
                    await message.delete()
                if payload.emoji == "🆘":
                    embed: discord.Embed = message.embeds[0]
                    await client.get_user(embed.fields[0].name).unban()
                    await message.delete()
            ...
            if payload.message.channel.id == self.devreportschannelid:
                ...
                if payload.emoji == "✔️":
                    ...
                    embed.set_author(name="BugReport", icon_url="https://cdn.discordapp.com/app-icons/742032003125346344/e4f214ec6871417509f6dbdb1d8bee4a.png?size=256")
                    embed.set_thumbnail(url="https://cdn.discordapp.com/app-icons/742032003125346344/e4f214ec6871417509f6dbdb1d8bee4a.png?size=256")
                    await client.get_channel(self.devreportschannelid).send(embed=embed, delete_after=10)

client.add_cog(BugReport.BugReport())
