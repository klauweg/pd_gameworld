...
async def help(ctx: commands.Context):
    ...
    if ctx.channel.id == 771745879723606107:
        ...
        page5 = 'Willst du Haustiere gewinnen um tolle Xp-Multiplikatoren oder Money-Multiplikatoren zu bekommen? Gehe in den Haustier Channel und schreibe !pet (kostet anfangs 300 Money). Deine Haustiere kannst du sehen indem du im Haustier Channel !pets schreibst!'
        page6 = 'Wenn du einen Bug gefunden hast schreibe bitte folgendes in den Bug-Report Channel: !bug "dein bug"! Danke für deine Hilfe:-) !'
        page7 = 'Auf den nächsten Seiten wird erklärt wie die jeweiligen Spiele funktionieren! ->'
        ...
        page12 = 'OneWordChallange:\nDer Reihe nach müssen die Spieler wörter aussuchen und daraus einen Satz bilden!'
        book = Book("Help", [page1, page2, page3, page4, page5, page6, page7, page8, page9, page10, page11, page12], client, 771745879723606107)
